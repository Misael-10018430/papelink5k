...
<head>
    ...
    * {
    ...
    body {
        ...
        padding: 0;
        /* CAMBIO: De 'hidden' a 'auto' para PERMITIR el scroll en móviles */
        overflow: auto; 
    }
    ...
    .login-wrapper {
        display: flex;
        width: 100%;
        /* CAMBIO: De 'height' a 'min-height' para PERMITIR que crezca */
        min-height: 100vh;
    }
    ...
    .login-section {
        ...
        align-items: center;
        padding: 40px;
        /* AÑADIDO: Asegura que tenga altura mínima en layout flex */
        min-height: 100vh;
    }
    ...
    .subtitulo {
        text-align: center;
        color: #555; /* Ajustado para que se lea mejor sobre el fondo claro */
        margin-bottom: 30px;
        font-size: 15px;
    }
    ...
    /* --- BLOQUE RESPONSIVE MEJORADO --- */
    @media (max-width: 768px) {
        .login-wrapper {
            flex-direction: column;
            /* CAMBIO: Deja que el contenido defina la altura */
            height: auto; 
        }
        
        .brand-section {
            flex: none;
            /* CAMBIO: De '30vh' a 'auto' para ser flexible */
            height: auto; 
            /* AÑADIDO: Un padding vertical para que respire */
            padding: 50px 20px; 
            text-align: center;
        }
        
        .brand-name {
            font-size: 4rem; /* Un poco más grande que tu 2.5rem */
        }
        ...
        .login-section {
            flex: 1;
            padding: 20px;
            /* AÑADIDO: Asegura que ocupe el ancho y no tenga altura mínima */
            width: 100%;
            min-height: auto;
        }
        ...
        .login-container {
            padding: 30px 20px;
            /* AÑADIDO: Un poco de margen inferior en móvil */
            margin-bottom: 20px; 
        }
